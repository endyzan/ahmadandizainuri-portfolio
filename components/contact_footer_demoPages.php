<section id="ctn_emailSender" class="fadeInBottom">
    ...
    <?php  
                if(isset($_POST["enviarMail"])) {
                    ...
                    if(isset($_POST['emisor']) && $emisor = filter_var($emisor, FILTER_VALIDATE_EMAIL)) {
                        ...
                        mail('andizainuri12@gmail.com', $asunto, $mensajeMail, "From: " . $emisor); //destinatario, asunto, mensaje, quien lo envía
  ...
  <div>
    <img src="../../img/index/contact.svg"
      alt="Ilustracion de una chica mirando una computadora que notifica que alguien está escribiendo un mensaje.">
  </div>
</section>
</main>
<footer>
